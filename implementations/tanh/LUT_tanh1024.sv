module tanh_lut #(
    parameter AW = 10, // szerokość adresu (1024 komórki)
    ...
    initial begin
        // ładowanie wygenerowanych danych
    ...
    //
    // Przykłady (Q=12, AW=10):
    //   x = -4.0  ->  x_int = -16384 ->  addr =    0
    //   x =  0.0  ->  x_int =      0  ->  addr =  512
    //   x = +4.0  ->  x_int = +16384  ->  addr = 1023 (nasycenie)
    // ---------------------------------------------------------------
    localparam OFFSET = 4 << Q; // 4.0 w formacie Q -> 16384 dla Q=12
    localparam RSHIFT = Q + 3 - AW;  // 5 dla Q=12, AW=10
